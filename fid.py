...
def graphs():
    ...
    wgan = [342.5477986137766, 153.64146628806358, 176.14136466424446, 159.1875071261975, 167.501440038873, 151.04257100023824, 152.20484248650615, 155.2294039254595, 155.1249939381108, 155.18038884868992, 202.4281066699823]
    plt.plot(xs, dcgan, label='dcgan')
    plt.plot(xs, dcgan_augmented, label='dcgan w/ augmentation')
    plt.plot(xs, wgan, label='wgan')
